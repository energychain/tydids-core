$(document).ready(function(e) {
    $('#createSSI').on('click',function(e) {
        ...
        $('#hiddenIdentity').val(ssi.getIdentity());
        ...
        const signAndDownload = async function() {
                ...
                <nav class="navbar navbar-expand-md sticky-top bg-body-tertiary shadow d-print-none">
                    <div class="container-fluid">
                        <h1 class="display-6" style="padding-top: 12px;"><a class="btn btn-lg fs-2" role="button" target="_blank" href="https://tydids.com/"><span style="color: #147a50;"><svg class="bi bi-database-check" xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" style="margin-top: -12px;margin-right: 10px;">
                                    ...
                                    </svg><span style="background-color: rgb(255, 255, 255);">tydids</span></span><span style="color: #e6b41e;">DataIdentity</span></a></h1><a class="navbar-brand d-none d-md-block" data-bs-toggle="tooltip" data-bss-tooltip data-bs-placement="bottom" title><button id="btnMyQR" class="btn btn-dark" type="button" style="display: none;"><svg class="bi bi-qr-code" xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16">
            ...
            a.click(); 
            await ssi.publish();
            $('#pivacyConfirmed').removeAttr('disabled');            
        }

        signAndDownload();
    });
    $('#pivacyConfirmed').on('change',function(e) {
        if($('#pivacyConfirmed').is(':checked')) {
